...
// `tsconfig.base.json`, `.eslintrc.json`, `.env.example` — private workspace #44 widened this past the old
...
// the quadratic backtracking the previous slash form had (an O(n²) ReDoS — private workspace #15).
...
// fallback when none are backticked — keeping only the **path-like** ones (private workspace #44). Path-validating
